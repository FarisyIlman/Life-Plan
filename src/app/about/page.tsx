  ...
  return (
    <main className="min-h-screen bg-bg-primary text-text-primary">
      ...
      <section className="min-h-[60vh] flex flex-col items-center justify-center text-center px-6 py-20">
        ...
        >
          The Logician behind the code — an INTP whod rather build something
          than talk about building it. Welcome to the part of the site that isnt
          a CV.
        </motion.p>
      </section>
      ...
      <section className="border-t border-border px-6 py-16 text-center">
        <h2 className="font-heading text-2xl md:text-3xl mb-4">
          Thats the person behind the timeline.
        </h2>
